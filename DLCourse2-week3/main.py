...
def model(X_train,Y_train,X_test,Y_test,learning_rate=0.0001,nums_epochs=1400,minibatch_size=32,print_cost=True,is_plot=True,keep_prob=1.0):
    ...
    Z3 = forward_propagation(X,parameters,keep_prob=0.8)
